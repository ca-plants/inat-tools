    ...
    static async getObservationData(api, filter, progressReporter) {
        const url = filter.getURL(
            "https://api.inaturalist.org/v2/observations?verifiable=true&order_by=observed_on&per_page=500&" +
                `fields=(geoprivacy:!t,id:!t,location:!t,observed_on_string:!t,place_guess:!t,private_location:!t,private_place_guess:!t,positional_accuracy:!t,public_positional_accuracy:!t,quality_grade:!t,taxon:${TAXON_FIELDS},taxon_geoprivacy:!t,user:(id:!t,login:!t,name:!t))`,
        );
